<?php 
	...
	if (isset($_POST['reg_user'])) {
		...
		$sql_2 = "SELECT * FROM feusers WHERE reciept='$reciept'";
		...
		$query = "INSERT INTO feusers (fullname,password,passport,residence,education,reciept,country,query_status)
	...
	if (isset($_POST['login_user'])) {
		...
		if (count($errors) == 0) {
			...
			$query = "SELECT * FROM feusers WHERE fullname='$username' AND password='$password'";
