<?php 
	...
	if (isset($_POST['reg_user'])) {
		...
		$sql_2 = "SELECT * FROM biusers WHERE reciept='$reciept'";
		...
		$sql_4 = "SELECT * FROM pdusers WHERE reciept='$reciept'";
	    ...
	    $sql_5 = "SELECT * FROM feusers WHERE reciept='$reciept'";
		...
		$query = "INSERT INTO biusers (fullname,password,passport,residence,education,reciept,country,query_status)
	...
	if (isset($_POST['login_user'])) {
		...
		if (count($errors) == 0) {
			...
			$query = "SELECT * FROM biusers WHERE fullname='$username' AND password='$password'";
